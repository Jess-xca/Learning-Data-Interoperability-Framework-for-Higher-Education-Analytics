...
import { X, Edit2, Users, ExternalLink } from "lucide-react";
    ...
    <>
      <MainContent>
        ...
        <div className="mb-10 space-y-2">
          <h1 className="h-page text-primary">Courses</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <Card className="p-6">
                  ...
                  <p className="text-4xl font-bold text-tertiary">
                    {
                      filteredCourses.filter((c) => c.status === "active")
                        .length
                    }
                  </p>
                </Card>
              ...
              <Card className="p-8 border-l-4 border-primary space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-tertiary-fixed/20 p-4 rounded-lg">
                    ...
                    <p className="text-3xl font-bold text-tertiary">
                      {Math.round(
                        (selectedCourse.enrollment / selectedCourse.capacity) *
                          100,
                      )}
                      %
                    </p>
                ...
                <div className="border-t border-outline-variant/20 pt-6">
                  ...
                  <p className="text-sm text-on-surface-variant mb-4">
                    {selectedCourse.enrollment} of {selectedCourse.capacity}{" "}
                    students
                  </p>
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-sm text-on-surface-variant font-medium">
                      GPA trends, graduation rates, and academic progress
                    </p>
                  </div>
                  <Badge variant="primary">Quarterly</Badge>
                </div>
